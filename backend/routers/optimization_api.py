...
The legacy /optimize endpoint is kept for backwards compatibility. New
portfolio optimization is exposed through /optimize/multi-asset.
"""
...
def optimize_multi_asset(request: MultiAssetOptimizeRequest):
    """Optimize solar, batteries, EVs and flexible loads as one VPP."""
