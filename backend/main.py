...
from backend.routers.dashboard_snapshot_api import router as dashboard_snapshot_router
...
app.include_router(dashboard_snapshot_router, dependencies=_auth_dep)
