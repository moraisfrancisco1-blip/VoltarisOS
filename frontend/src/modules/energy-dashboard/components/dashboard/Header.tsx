      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <button
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'linear-gradient(135deg, rgba(52,211,153,0.25), rgba(16,185,129,0.25))';
              (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(52,211,153,0.5)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'linear-gradient(135deg, rgba(52,211,153,0.15), rgba(16,185,129,0.15))';
              ...
              {[
                ...
                <a
                  ...
                  onMouseEnter={e => {
                    ...
                    (e.currentTarget as HTMLAnchorElement).style.borderColor = `${plan.color}60`;
                  }}
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLAnchorElement).style.background = plan.popular ? `${plan.color}12` : 'rgba(255,255,255,0.03)';
                    (e.currentTarget as HTMLAnchorElement).style.borderColor = plan.popular ? `${plan.color}40` : 'rgba(255,255,255,0.07)';
                  }}
                >
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      {plan.popular && (
                        <span style={{
                          ...
                          background: `${plan.color}30`, color: plan.color,
                        }}>POPULAR</span>
                      )}
                      {plan.trial && (
                        <span style={{
