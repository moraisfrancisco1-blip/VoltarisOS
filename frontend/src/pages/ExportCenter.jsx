  ...
  return (
    <div style={{ padding: "32px", maxWidth: "1000px" }}>
      ...
      <div style={{ marginBottom: "28px" }}>
        ...
        <p style={{ color: "#4b5563", fontSize: "14px" }}>{t("exp_sub") || "Export any report with custom branding"}</p>
      </div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ color: "#6b7280", fontSize: "11px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "8px" }}>{t("format") || "Format"}</div>
        ...
        <div>
          <div style={{ color: "#6b7280", fontSize: "11px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "8px" }}>{t("period") || "Period"}</div>
        ...
        <label style={{ display: "flex", alignItems: "center", gap: "8px", cursor: "pointer" }}>
          ...
          />
          <span style={{ color: "#9ca3af", fontSize: "13px" }}>{t("include_branding") || "Include logo & branding"}</span>
        </label>
