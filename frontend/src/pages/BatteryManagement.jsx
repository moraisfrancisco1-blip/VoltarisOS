...
export default function BatteryManagement() {
  ...
  return (
    <div style={{ padding: 32, color: "#e5e7eb", minHeight: "100vh", background: "#0a0f1a" }}>
      ...
      <p style={{ color: "#6b7280", marginBottom: 28 }}>State of charge, health, and lifecycle tracking across all BESS assets</p>
        ...
        <div style={card}>
          ...
          {mockBatteries.map((b, i) => (
            <div key={b.id}
              ...
              style={{
                background: selected === i ? "#1f2937" : "#0d1117",
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                <div>
                  ...
                  <span style={{ color: "#6b7280", fontSize: 12, marginLeft: 8 }}>{b.site} · {b.chemistry} · {b.capacity} kWh</span>
                </div>
                <span style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span style={{ fontSize: 12, color: "#9ca3af", width: 60 }}>SoC {b.soc}%</span>
          ...
          {bat ? (
            <>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 24, marginBottom: 24 }}>
                ...
                <div>
                  <div style={{ color: "#6b7280", fontSize: 12 }}>Battery Health (SoH)</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 20 }}>
                {[
                  ...
                  <div key={m.label} style={{ background: "#0d1117", padding: "10px 14px", borderRadius: 8 }}>
              ...
              <div>
                <div style={{ fontSize: 13, color: "#6b7280", marginBottom: 8 }}>24h SoC History</div>
              ...
              <div style={{ marginTop: 16 }}>
                <div style={{ fontSize: 13, color: "#6b7280", marginBottom: 8 }}>Degradation Forecast</div>
                <div style={{ background: "#0d1117", borderRadius: 8, padding: 12 }}>
                  {[
                    ...
                    <div key={r.year} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
                      <span style={{ width: 50, fontSize: 12, color: "#6b7280" }}>{r.year}</span>
