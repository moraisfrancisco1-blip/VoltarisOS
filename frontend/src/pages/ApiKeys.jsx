  ...
  return (
    <div style={{ padding: "32px", maxWidth: "900px" }}>
      ...
      {newKey && (
        <div style={{
          ...
          <button onClick={() => setNewKey(null)} style={{
            background: "none", border: "none", color: "#4b5563", cursor: "pointer", fontSize: "20px",
          }}>×</button>
        </div>
      )}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {keys.map(k => (
          <div key={k.id} style={{
            background: "#111827", border: `1px solid ${k.active ? "#1a2234" : "#2d1515"}`,
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <span style={{
                  ...
                  border: "1px solid #1e2d45", borderRadius: "20px",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <code style={{
                flex: 1, padding: "8px 14px", background: "#0d1525",
              ...
              <button
                ...
                style={{
                  padding: "8px 12px", background: "#0d1525", border: "1px solid #1e2d45",
                  borderRadius: "8px", color: "#6b7280", cursor: "pointer", fontSize: "12px",
                }}
      ...
      <div style={{
        ...
        background: "#0f1e35", border: "1px solid #1e2d45",
        borderRadius: "12px", display: "flex", alignItems: "center", gap: "12px",
      }}>
        <span style={{ fontSize: "20px" }}>📖</span>
        <div>
          <div style={{ color: "#9ca3af", fontSize: "13px", fontWeight: "600", marginBottom: "2px" }}>API Documentation</div>
