    ...
    <div style={{ padding: 32, color: "var(--text)", minHeight: "100vh", background: "var(--surface)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginBottom: 24 }}>
        {[
          ...
          <div key={k.label} style={card}>
            <div style={{ color: "rgba(148,163,184,0.85)", fontSize: 12, marginBottom: 4 }}>{k.label}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 20 }}>
        ...
        <div style={{ ...card, padding: 0, overflow: "hidden", minHeight: 500 }}>
          ...
          {!mapReady && (
            <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", color: "rgba(148,163,184,0.85)", fontSize: 13 }}>
              Loading map...
            </div>
          )}
        </div>
            ...
            <div key={s.id}
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "rgba(148,163,184,0.85)" }}>{s.country}</div>
                </div>
                <span style={{
              ...
              <div style={{ fontSize: 12, color: "rgba(148,163,184,0.85)", marginBottom: 8 }}>{s.type}</div>
