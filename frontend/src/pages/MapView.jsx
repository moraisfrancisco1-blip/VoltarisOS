...
const accent = "#6366f1";
const card = { background: "#111827", border: "1px solid #1f2937", borderRadius: 12, padding: 20 };
...
export default function MapView() {
  ...
  return (
    <div style={{ padding: 32, color: "#e5e7eb", minHeight: "100vh", background: "#0a0f1a" }}>
      ...
      <p style={{ color: "#6b7280", marginBottom: 24 }}>Geographic overview of all VPP assets</p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginBottom: 24 }}>
        {[
          ...
          <div key={k.label} style={card}>
            <div style={{ color: "#6b7280", fontSize: 12, marginBottom: 4 }}>{k.label}</div>
          ...
          {sites.map(s => (
            <div key={s.id}
              ...
              style={{
                ...
                background: selected?.id === s.id ? "#1a1f35" : "#111827",
              }}>
              ...
              <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 8 }}>{s.type}</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
                {[
                  ...
                  <div key={m.label} style={{ background: "#0d1117", padding: "6px 10px", borderRadius: 6 }}>
