    ...
    <div style={{ padding: "28px", maxWidth: "1400px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "28px", flexWrap: "wrap", gap: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            <p style={{ color: "#4b5563", fontSize: "13px", marginTop: "2px" }}>AI executa ordens automaticamente · Override manual disponível</p>
          </div>
        </div>
      ...
      {status && (
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "16px", marginBottom: "20px" }}>
          {[
            ...
            { label: "Última Ação", value: status.last_action, color: "#9ca3af", small: true },
          ].map((s, i) => (
            <div key={i} style={{ background: "linear-gradient(135deg,#111827,#0f1724)", borderRadius: "12px", padding: "16px", border: "1px solid #1a2234" }}>
              <div style={{ color: "#4b5563", fontSize: "10px", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "6px" }}>{s.label}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: "16px", marginBottom: "16px" }}>
        ...
        <div style={{ background: "linear-gradient(135deg,#111827,#0f1724)", borderRadius: "14px", padding: "20px", border: "1px solid #1a2234" }}>
          ...
          <div style={{ color: "#4b5563", fontSize: "11px", marginBottom: "16px" }}>Lucro acumulado do agente (€)</div>
          <ResponsiveContainer width="100%" height={180}>
            <LineChart data={pnlHistory} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
              <XAxis dataKey="t" stroke="#1f2937" tick={{ fill: "#374151", fontSize: 9 }} interval="preserveStartEnd" />
        ...
        <div style={{ background: "linear-gradient(135deg,#111827,#0f1724)", borderRadius: "14px", padding: "20px", border: "1px solid #1a2234" }}>
          ...
          {[
            ...
            <div key={f.key} style={{ marginBottom: "12px" }}>
              <label style={{ color: "#6b7280", fontSize: "11px", display: "block", marginBottom: "4px" }}>{f.label}</label>
              <input
                type="number"
                value={config[f.key]}
                onChange={e => setConfig(c => ({ ...c, [f.key]: +e.target.value }))}
                style={{
                  width: "100%", background: "#0d1525", border: "1px solid #1a2234",
