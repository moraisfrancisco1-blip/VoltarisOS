    ...
    <div style={{ padding: 32, color: "#e5e7eb", minHeight: "100vh", background: "#0a0f1a" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28 }}>
        <div>
          ...
          <p style={{ color: "#6b7280" }}>Manage team access, roles, and site permissions</p>
        </div>
        ...
        <div style={{ ...card, marginBottom: 24, border: `1px solid ${accent}` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 16 }}>
            ...
            <div>
              ...
              <select value={inviteForm.role} onChange={e => setInviteForm(p => ({ ...p, role: e.target.value }))}
                style={{ background: "#0d1117", border: "1px solid #1f2937", borderRadius: 8, padding: "9px 12px", color: "#e5e7eb", fontSize: 13, width: "100%" }}>
            ...
            <div>
              <label style={{ fontSize: 12, color: "#6b7280", display: "block", marginBottom: 4 }}>Site Access</label>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button onClick={() => setShowInvite(false)} style={{
              background: "#1f2937", color: "#9ca3af", border: "none", borderRadius: 8, padding: "9px 16px", cursor: "pointer", fontSize: 13,
            }}>Cancel</button>
          </div>
        </div>
      )}
      ...
      <div style={card}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          ...
          <input placeholder="Search by name or email..." value={search}
            ...
            style={{
              background: "#0d1117", border: "1px solid #1f2937", borderRadius: 8,
              padding: "8px 14px", color: "#e5e7eb", fontSize: 13, width: 240,
            }} />
        </div>
            ...
            {filtered.map(u => {
              ...
              return (
                <tr key={u.id} style={{ borderBottom: "1px solid #0d1117" }}>
                  ...
                  <td style={{ padding: "12px", color: "#9ca3af" }}>{u.site}</td>
                  <td style={{ padding: "12px" }}>
                    <span style={{
                  ...
                  <td style={{ padding: "12px", color: "#6b7280" }}>{u.lastLogin}</td>
                  <td style={{ padding: "12px" }}>
      ...
      <div style={{ ...card, marginTop: 20 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 }}>
          {[
            ...
            return (
              <div key={r.role} style={{ background: "#0d1117", padding: 14, borderRadius: 10 }}>
                <span style={{ fontSize: 12, padding: "2px 8px", borderRadius: 99, background: rc.bg, color: rc.text, textTransform: "capitalize" }}>
                  {r.label}
                </span>
                <ul style={{ marginTop: 10, paddingLeft: 16, fontSize: 12, color: "#6b7280", lineHeight: 1.8 }}>
