...
const T = {
  ...
  change_avatar:   { pt:"Alterar avatar", en:"Change avatar", fr:"Changer l'avatar", es:"Cambiar avatar", nl:"Avatar wijzigen" },
  remove_avatar:   { pt:"Remover avatar", en:"Remove avatar", fr:"Supprimer l'avatar", es:"Quitar avatar", nl:"Avatar verwijderen" },
  avatar_updated:  { pt:"Avatar atualizado", en:"Avatar updated", fr:"Avatar mis à jour", es:"Avatar actualizado", nl:"Avatar bijgewerkt" },
  avatar_removed:  { pt:"Avatar removido", en:"Avatar removed", fr:"Avatar supprimé", es:"Avatar eliminado", nl:"Avatar verwijderd" },
  avatar_upload_error: { pt:"Não foi possível atualizar o avatar. Verifica o formato (PNG/JPEG/WebP/GIF) e o tamanho (máx. 300KB).", en:"Could not update the avatar. Check the format (PNG/JPEG/WebP/GIF) and size (max 300KB).", fr:"Impossible de mettre à jour l'avatar. Vérifiez le format (PNG/JPEG/WebP/GIF) et la taille (max 300 Ko).", es:"No se pudo actualizar el avatar. Comprueba el formato (PNG/JPEG/WebP/GIF) y el tamaño (máx. 300KB).", nl:"Kon de avatar niet bijwerken. Controleer het formaat (PNG/JPEG/WebP/GIF) en de grootte (max 300KB)." },
  profile_save_error: { pt:"Não foi possível guardar o perfil.", en:"Could not save the profile.", fr:"Impossible d'enregistrer le profil.", es:"No se pudo guardar el perfil.", nl:"Kon het profiel niet opslaan." },
  profile_password_both_required: { pt:"Preenche a password atual e a nova para a alterar.", en:"Fill in both the current and new password to change it.", fr:"Remplissez le mot de passe actuel et le nouveau pour le changer.", es:"Rellena la contraseña actual y la nueva para cambiarla.", nl:"Vul zowel het huidige als het nieuwe wachtwoord in om het te wijzigen." },
  profile_password_error: { pt:"Não foi possível alterar a password.", en:"Could not change the password.", fr:"Impossible de changer le mot de passe.", es:"No se pudo cambiar la contraseña.", nl:"Kon het wachtwoord niet wijzigen." },
  ...
  audit_forbidden:      { pt:"Acesso restrito a administradores da organização.", en:"Restricted to organization administrators.", fr:"Réservé aux administrateurs de l'organisation.", es:"Restringido a administradores de la organización.", nl:"Alleen voor organisatiebeheerders." },
  audit_load_error:     { pt:"Não foi possível carregar o registo de auditoria.", en:"Could not load the audit log.", fr:"Impossible de charger le journal d'audit.", es:"No se pudo cargar el registro de auditoría.", nl:"Kon het auditlog niet laden." },
  audit_showing_subset: { pt:"A mostrar {shown} de {total} eventos", en:"Showing {shown} of {total} events", fr:"Affichage de {shown} sur {total} événements", es:"Mostrando {shown} de {total} eventos", nl:"{shown} van {total} gebeurtenissen weergegeven" },
  ...
  apikeys_rotate:       { pt:"Rodar", en:"Rotate", fr:"Faire pivoter", es:"Rotar", nl:"Roteren" },
  apikeys_rotated:      { pt:"API Key rodada — a chave antiga já não funciona", en:"API Key rotated — the old key no longer works", fr:"Clé API pivotée — l'ancienne clé ne fonctionne plus", es:"API Key rotada — la clave anterior ya no funciona", nl:"API-sleutel geroteerd — de oude sleutel werkt niet meer" },
  apikeys_empty:        { pt:"Ainda não tens nenhuma API Key.", en:"No API keys yet.", fr:"Aucune clé API pour l'instant.", es:"Aún no tienes ninguna API Key.", nl:"Nog geen API-sleutels." },
  apikeys_forbidden:    { pt:"Acesso restrito a administradores da organização.", en:"Restricted to organization administrators.", fr:"Réservé aux administrateurs de l'organisation.", es:"Restringido a administradores de la organización.", nl:"Alleen voor organisatiebeheerders." },
  apikeys_load_error:   { pt:"Não foi possível carregar as API Keys.", en:"Could not load API keys.", fr:"Impossible de charger les clés API.", es:"No se pudieron cargar las API Keys.", nl:"Kon de API-sleutels niet laden." },
  apikeys_scope_note:   { pt:"A chave tem o mesmo acesso que um membro normal da tua organização.", en:"The key has the same access as a regular member of your organization.", fr:"La clé a le même accès qu'un membre normal de votre organisation.", es:"La clave tiene el mismo acceso que un miembro normal de tu organización.", nl:"De sleutel heeft dezelfde toegang als een gewoon lid van je organisatie." },
  ...
  oauth_connected_toast:{ pt:"ligado com sucesso", en:"connected successfully", fr:"connecté avec succès", es:"conectado correctamente", nl:"succesvol verbonden" },
  oauth_connect_failed: { pt:"Falha ao ligar", en:"Failed to connect", fr:"Échec de la connexion", es:"Error al conectar", nl:"Verbinden mislukt" },
  oauth_not_configured: { pt:"Não configurado nesta instância", en:"Not configured on this instance", fr:"Non configuré sur cette instance", es:"No configurado en esta instancia", nl:"Niet geconfigureerd op deze instantie" },
  ...
  whitelabel_your_domain:      { pt:"O Teu Domínio Personalizado", en:"Your Custom Domain", fr:"Votre domaine personnalisé", es:"Tu dominio personalizado", nl:"Jouw eigen domein" },
  whitelabel_your_domain_sub:  { pt:"Serve o VoltarisOS no teu próprio domínio em vez de voltarisos.com.", en:"Serve VoltarisOS at your own domain instead of voltarisos.com.", fr:"Diffusez VoltarisOS sur votre propre domaine au lieu de voltarisos.com.", es:"Sirve VoltarisOS en tu propio dominio en lugar de voltarisos.com.", nl:"Serveer VoltarisOS op je eigen domein in plaats van voltarisos.com." },
  whitelabel_add_domain:       { pt:"Adicionar Domínio", en:"Add Domain", fr:"Ajouter un domaine", es:"Añadir dominio", nl:"Domein toevoegen" },
  whitelabel_refresh:          { pt:"Atualizar", en:"Refresh", fr:"Actualiser", es:"Actualizar", nl:"Vernieuwen" },
  whitelabel_remove_domain:    { pt:"Remover", en:"Remove", fr:"Supprimer", es:"Eliminar", nl:"Verwijderen" },
  whitelabel_domain_load_error:   { pt:"Não foi possível carregar o estado do domínio.", en:"Could not load domain status.", fr:"Impossible de charger l'état du domaine.", es:"No se pudo cargar el estado del dominio.", nl:"Kon domeinstatus niet laden." },
  whitelabel_domain_request_error:{ pt:"Não foi possível pedir o domínio.", en:"Could not request the domain.", fr:"Impossible de demander le domaine.", es:"No se pudo solicitar el dominio.", nl:"Kon het domein niet aanvragen." },
  whitelabel_domain_remove_error: { pt:"Não foi possível remover o domínio.", en:"Could not remove the domain.", fr:"Impossible de supprimer le domaine.", es:"No se pudo eliminar el dominio.", nl:"Kon het domein niet verwijderen." },
  whitelabel_manual_setup_note:   { pt:"Esta instância ainda não está ligada a um fornecedor de domínios — um admin da plataforma precisa de terminar esta configuração. As instruções de DNS aparecem aqui automaticamente assim que isso acontecer.", en:"This instance isn't connected to a domain provider yet — a platform admin needs to finish setting this up. You'll see DNS instructions here automatically once that's done.", fr:"Cette instance n'est pas encore connectée à un fournisseur de domaine — un administrateur de la plateforme doit terminer cette configuration. Les instructions DNS apparaîtront ici automatiquement une fois cela fait.", es:"Esta instancia aún no está conectada a un proveedor de dominios — un administrador de la plataforma debe terminar esta configuración. Verás las instrucciones DNS aquí automáticamente en cuanto esté listo.", nl:"Deze instantie is nog niet gekoppeld aan een domeinprovider — een platformbeheerder moet dit nog afronden. Je ziet hier automatisch DNS-instructies zodra dat gebeurd is." },
  whitelabel_dns_instructions:    { pt:"Adiciona estes registos DNS no teu fornecedor de domínio:", en:"Add these DNS records at your domain provider:", fr:"Ajoutez ces enregistrements DNS chez votre fournisseur de domaine :", es:"Añade estos registros DNS en tu proveedor de dominio:", nl:"Voeg deze DNS-records toe bij je domeinprovider:" },
  whitelabel_status_pending_manual_setup: { pt:"A aguardar configuração manual", en:"Awaiting manual setup", fr:"En attente de configuration manuelle", es:"Esperando configuración manual", nl:"Wacht op handmatige installatie" },
  whitelabel_status_pending_dns:  { pt:"A aguardar DNS", en:"Awaiting DNS", fr:"En attente du DNS", es:"Esperando DNS", nl:"Wacht op DNS" },
  whitelabel_status_active:       { pt:"Ativo", en:"Active", fr:"Actif", es:"Activo", nl:"Actief" },
  whitelabel_status_error:        { pt:"Erro", en:"Error", fr:"Erreur", es:"Error", nl:"Fout" },
  ...
  // ─── FIRST USER (tenant onboarding) ──────────────────────────────────────────
  sa_first_user_title:  { pt:"Primeiro utilizador", en:"First user", fr:"Premier utilisateur", es:"Primer usuario", nl:"Eerste gebruiker" },
  sa_first_user_hint:   { pt:"Este utilizador terá de alterar a password no primeiro login.", en:"This user must change the password on first login.", fr:"Cet utilisateur devra changer le mot de passe à la première connexion.", es:"Este usuario deberá cambiar la contraseña en el primer inicio de sesión.", nl:"Deze gebruiker moet het wachtwoord bij de eerste aanmelding wijzigen." },
  sa_field_admin_name:  { pt:"Nome do utilizador", en:"User name", fr:"Nom de l'utilisateur", es:"Nombre del usuario", nl:"Naam van de gebruiker" },
  sa_field_admin_email: { pt:"Email do utilizador", en:"User email", fr:"E-mail de l'utilisateur", es:"Email del usuario", nl:"E-mailadres van de gebruiker" },
  sa_field_admin_pass:  { pt:"Password temporária", en:"Temporary password", fr:"Mot de passe temporaire", es:"Contraseña temporal", nl:"Tijdelijk wachtwoord" },
  sa_admin_pass_ph:     { pt:"deixa vazio para gerar", en:"leave empty to generate", fr:"laisser vide pour générer", es:"dejar vacío para generar", nl:"leeg laten om te genereren" },
  sa_invalid_email:     { pt:"Email inválido.", en:"Invalid email.", fr:"E-mail invalide.", es:"Email no válido.", nl:"Ongeldig e-mailadres." },
  sa_short_password:    { pt:"A password deve ter pelo menos 8 caracteres.", en:"The password must be at least 8 characters.", fr:"Le mot de passe doit contenir au moins 8 caractères.", es:"La contraseña debe tener al menos 8 caracteres.", nl:"Het wachtwoord moet minstens 8 tekens bevatten." },
  sa_created_user:      { pt:"Tenant e primeiro utilizador criados.", en:"Tenant and first user created.", fr:"Tenant et premier utilisateur créés.", es:"Tenant y primer usuario creados.", nl:"Tenant en eerste gebruiker aangemaakt." },
  sa_temp_pass_once:    { pt:"Esta password temporária só é mostrada uma vez. Entrega-a ao utilizador.", en:"This temporary password is shown only once. Hand it to the user.", fr:"Ce mot de passe temporaire n'est affiché qu'une seule fois. Remettez-le à l'utilisateur.", es:"Esta contraseña temporal solo se muestra una vez. Entrégasela al usuario.", nl:"Dit tijdelijke wachtwoord wordt slechts één keer getoond. Geef het aan de gebruiker." },
  sa_copy:              { pt:"Copiar", en:"Copy", fr:"Copier", es:"Copiar", nl:"Kopiëren" },

  // ─── FORCED FIRST-LOGIN PASSWORD CHANGE ──────────────────────────────────────
  pw_gate_title:        { pt:"Alterar password", en:"Change password", fr:"Changer le mot de passe", es:"Cambiar contraseña", nl:"Wachtwoord wijzigen" },
  pw_gate_intro:        { pt:"Estás a usar uma password temporária. Define uma nova password para continuares.", en:"You are using a temporary password. Set a new password to continue.", fr:"Vous utilisez un mot de passe temporaire. Définissez un nouveau mot de passe pour continuer.", es:"Estás usando una contraseña temporal. Define una nueva contraseña para continuar.", nl:"Je gebruikt een tijdelijk wachtwoord. Stel een nieuw wachtwoord in om verder te gaan." },
  pw_gate_current:      { pt:"Password temporária", en:"Temporary password", fr:"Mot de passe temporaire", es:"Contraseña temporal", nl:"Tijdelijk wachtwoord" },
  pw_gate_new:          { pt:"Nova password", en:"New password", fr:"Nouveau mot de passe", es:"Nueva contraseña", nl:"Nieuw wachtwoord" },
  pw_gate_confirm:      { pt:"Confirmar nova password", en:"Confirm new password", fr:"Confirmer le nouveau mot de passe", es:"Confirmar nueva contraseña", nl:"Nieuw wachtwoord bevestigen" },
  pw_gate_submit:       { pt:"Guardar e continuar", en:"Save and continue", fr:"Enregistrer et continuer", es:"Guardar y continuar", nl:"Opslaan en doorgaan" },
  pw_gate_short:        { pt:"A nova password deve ter pelo menos 8 caracteres.", en:"The new password must be at least 8 characters.", fr:"Le nouveau mot de passe doit contenir au moins 8 caractères.", es:"La nueva contraseña debe tener al menos 8 caracteres.", nl:"Het nieuwe wachtwoord moet minstens 8 tekens bevatten." },
  pw_gate_mismatch:     { pt:"As passwords não coincidem.", en:"The passwords do not match.", fr:"Les mots de passe ne correspondent pas.", es:"Las contraseñas no coinciden.", nl:"De wachtwoorden komen niet overeen." },
  pw_gate_error:        { pt:"Não foi possível alterar a password.", en:"Could not change the password.", fr:"Impossible de modifier le mot de passe.", es:"No se pudo cambiar la contraseña.", nl:"Het wachtwoord kon niet worden gewijzigd." },
  pw_gate_cancel:       { pt:"Sair", en:"Sign out", fr:"Se déconnecter", es:"Cerrar sesión", nl:"Afmelden" },
